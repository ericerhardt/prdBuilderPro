...
const PLANS = [
  {
    ...
    stripePriceIdYearly: '',
    features: [
      '3 documents per month (PRDs + AI Instructions)',
      '2 version history',
      'Basic platforms (Replit, Bolt.new, Claude Code, Cursor)',
      'Export to Markdown',
      'Community support',
    ],
    limitations: [
  ...
  },
  {
    ...
    features: [
      'Unlimited PRDs & AI Instructions',
      'Unlimited version history',
      'All platforms (Leap.new, Lovable, Aider, Windsurf)',
      'All instruction types (Sub-agents, Skills, MCP)',
...
export default function PricingPage() {
  ...
  const handleSubscribe = async (planId: string) => {
    if (planId === 'free') {
      // Check if user is logged in for free plan
        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left max-w-4xl mx-auto mt-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Our Free plan lets you try PRD Builder Pro with up to 3 documents per month, no credit card required.
              </p>
            </div>
